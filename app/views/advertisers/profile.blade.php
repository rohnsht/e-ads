...
@section('navbar')
    <ul id="navs" class="nav navbar-nav">
        ...
        <li class="active"><a href="{{ URL::route('advertiser-profile', $user->username) }}">
                    ...
                    <div class="panel-body">                      
                        ...
                        <div class="col-md-6">
                            <div class="default-section panel panel-success">
                                ...
                                {{ Form::open([ 'class'=>'form-horizontal', 'route'=>['advertiser-changePassword',$user->username]]) }}
                                    <div class="panel-body">
                            ...
                            <div class="default-section panel panel-default">
                                ...
                                <div class="panel-body">
                                    <a href="{{ URL::route('advertiser-payment') }}" data-paypal-button="true">
